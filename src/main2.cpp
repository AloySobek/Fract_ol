...
//             if (fullscreen)
//             {
//                 glfwSetWindowMonitor(window, NULL, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT,
//                                      GLFW_DONT_CARE);
//
//                 fullscreen = 0;
//             }
//             else
//             {
//                 glfwSetWindowMonitor(window, glfwGetPrimaryMonitor(), 0, 0, WINDOW_WIDTH,
//                                      WINDOW_HEIGHT, GLFW_DONT_CARE);
//                 fullscreen = 1;
//             }
//         }
//
...
// {
//     GLFWwindow *window = init_window("Charlotte");
//
